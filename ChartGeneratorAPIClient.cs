...
namespace APIVerve
{
    public class ChartGeneratorAPIClient
    {
        private readonly string _apiEndpoint = "https://api.apiverve.com/v1/chartgenerator";
        ...
        public ChartGeneratorAPIClient(string apiKey, bool isSecure = true)
        {
            _apiKey = apiKey;
            _isSecure = isSecure;
        }
        ...
        public ChartGeneratorAPIClient(string apiKey, bool isSecure = true, bool isDebug = false)
        {
            _apiKey = apiKey;
            _isSecure = isSecure;
            _isDebug = isDebug;
        ...
        public void ExecuteAsync(ExecuteAsyncCallback callback, ChartGeneratorQueryOptions options = null)
        {
        ...
        /// <param name="options"></param>
        /// <returns></returns>
        public ResponseObj Execute(ChartGeneratorQueryOptions options = null)
        {
            try
            {
                if (_isDebug)
        ...
        private string constructURL(ChartGeneratorQueryOptions options)
        {
